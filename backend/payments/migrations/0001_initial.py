    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_type', models.CharField(choices=[('payment', 'Payment'), ('refund', 'Refund'), ('payout', 'Payout'), ('wallet_funding', 'Wallet Funding'), ('wallet_withdrawal', 'Wallet Withdrawal')], max_length=20)),
                ...
                ('payuee_transaction_id', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(default='USD', max_length=3)),
                ('daily_limit', models.DecimalField(decimal_places=2, default=10000, max_digits=12)),
                ('monthly_limit', models.DecimalField(decimal_places=2, default=100000, max_digits=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('wallet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='history', to='payments.wallet')),
            ],
            options={
