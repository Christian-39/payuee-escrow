# Generated by Django 5.2.12 on 2026-08-10 15:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payuee_product_id', models.PositiveIntegerField(blank=True, db_index=True, help_text='Payuee product ID (integer, e.g., 92, 255)', null=True, unique=True)),
                ('payuee_vendor_id', models.PositiveIntegerField(blank=True, db_index=True, help_text='Payuee vendor ID (eshop_user_id, e.g., 19, 51) - required for shipping-fee calculation', null=True)),
                ('payuee_vendor_type', models.CharField(blank=True, help_text='Vendor subscription type (basic, premium, etc.)', max_length=20, null=True)),
                ('payuee_category', models.CharField(blank=True, db_index=True, help_text='Payuee category (e.g., outfits, jewelry, gadgets)', max_length=50, null=True)),
                ('payuee_product_url_id', models.CharField(blank=True, help_text='Payuee product URL slug (e.g., "italian-shoe-90")', max_length=255, null=True)),
                ('payuee_net_weight', models.DecimalField(blank=True, decimal_places=2, help_text='Product weight in kg from Payuee', max_digits=8, null=True)),
                ('payuee_stock_remaining', models.PositiveIntegerField(blank=True, help_text='Stock count from Payuee API (stock_remaining field)', null=True)),
                ('payuee_estimated_delivery', models.PositiveIntegerField(blank=True, help_text='Estimated delivery days from Payuee', null=True)),
                ('payuee_clothing_sizes', models.CharField(blank=True, help_text='Available clothing sizes from Payuee (e.g., "S,M,L,XL")', max_length=100, null=True)),
                ('payuee_shoe_sizes', models.CharField(blank=True, help_text='Available shoe sizes from Payuee (e.g., "30-40")', max_length=100, null=True)),
                ...
                ('payuee_last_synced', models.DateTimeField(blank=True, help_text='Last time product data was synced from Payuee', null=True)),
                ...
                ('images', models.JSONField(blank=True, default=list, help_text='List of image URLs. For Payuee products, prepend https://payuee.com/image/')),
